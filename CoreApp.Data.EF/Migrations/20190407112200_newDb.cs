        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Range = table.Column<string>(type: "varchar(20)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coupon = table.Column<string>(type: "varchar(50)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShowTimes_MovieTheaters_MovieTheaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillDetails_Seats_SeatId",
                        column: x => x.SeatId,
                        principalTable: "Seats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillDetails_ShowTimes_ShowTimeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advertisetments_PositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillDetails_SeatId",
                table: "BillDetails",
                column: "SeatId");

            migrationBuilder.CreateIndex(
                name: "IX_BillDetails_ShowTimeId",
                table: "BillDetails",
                column: "ShowTimeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShowTimes_MovieTheaterId",
                table: "ShowTimes",
